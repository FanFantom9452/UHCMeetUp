...
summon text_display ~-0.5 ~1 ~ {alignment:"center",Tags:["timer.death_chest"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.25f,1.25f,1.25f]},text:'{"bold":true,"color":"white","italic":false,"score":{"name":"#tmp_timer","objective":"timer.death_chest"}}',background:1678049280}
