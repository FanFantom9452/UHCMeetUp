...
#產生粒子特效
execute rotated as @e[type=marker,tag=particle_b] positioned ^ ^ ^1.6 rotated as @e[type=marker,tag=particle_a] run function fantomsmp:type/work/maho/magic_attack2_sub
